...
var header_images = ["/images/headers/header_prototype.jpg", "/images/headers/header_prototype2.jpg", "/images/headers/header_prototype3.jpg", "/images/headers/header_prototype4.jpg", "/images/headers/header_prototype5.jpg"];
function random_header_image() {
    ...
    // Kein Grund hier hacky und unsicher HTML zu ersetzen, die Quellenattribute kann auch direkt geändert werden.
    document.getElementById("ausgabe-bild").src = image_index; 
}
...
// NIEMALS (!) Funktionen nach APIs bennenen die im Browser Standard sind. Vorher hies die Funktion "console", wenn eine andere Funktion jetzt "console.debug" oder ähnliches aufruft, würde diese Funktion anstatt der Standard-API aufgerufen werden.
